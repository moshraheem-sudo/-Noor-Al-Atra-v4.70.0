...
class NotificationAlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        try {
            ...
            val quranEnabled = NotificationSettingsManager.isQuranEnabled(context)
            val azkarEnabled = NotificationSettingsManager.isAzkarEnabled(context)

            if (!quranEnabled && !azkarEnabled) {
                return
            }
            ...
            if ((isAyahTurn || !azkarEnabled) && quranEnabled) {
